...
function getEntryFormHTML(entry){
    return `
            ...
            <div class="edit-form__btn-group">
                <button id="updateRow" class="btn btn--blue edit-form__btn">Update</button>
                <button id="deleteRow" class="btn btn--blue edit-form__btn">Delete</button>
            </div>
            `;
}
